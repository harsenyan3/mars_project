        ...
        <section ref={sectionRefs.home} className="section home-section">
          ...
          <div className="home-content">
            ...
            <div className="home-socials">
              <a href="https://instagram.com/marsprojectatl" target="_blank" rel="noopener noreferrer" className="home-social-link" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>
              </a>
              <a href="https://tiktok.com/@marsprojectatl" target="_blank" rel="noopener noreferrer" className="home-social-link" aria-label="TikTok">
              ...
              <a href="https://linktr.ee/marsprojectatl" target="_blank" rel="noopener noreferrer" className="home-social-link" aria-label="All Links">
                <span>🔗</span>
              </a>
            </div>
          </div>
